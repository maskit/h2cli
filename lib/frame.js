...
Object.defineProperty(Http2Frame.prototype, 'streamId', {
    get: function () { return this.buf.readUInt32BE(4) & 0x7FFF; },
...
Http2HeadersFrame.prototype.setBlock = function (block, padding) {
    var length = 0
...
Http2PingFrame.prototype.toString = function () {
    var str = Http2Frame.prototype.toString.call(this) + "\n";
    str += this.buf.toString('hex', 8, 15);
    return str;
};
Http2PingFrame.prototype.getPayload = function () {
    return this.buf.slice(8, 15);
};
